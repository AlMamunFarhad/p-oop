          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="nav-img d-flex justify-content-center">
              <a class="navbar-brand" href="index.php">
                <img src="images/farhad.png" class="img-fluid rounded-pill" alt="">
              </a>
            </div>
            <div class="author-name">
              <h3><a href="./index.php">Farhad</a></h3>
            </div>
            ...
            <ul class="navbar-nav flex-column nav-links text-break text-center">
              <li class="nav-item">
                <a class="nav-link menu-active" href="index.php"><i class="fa-solid fa-user"></i> ABOUT US</a>
              </li>
              <hr>
              <li class="nav-item">
                <a class="nav-link" href="./resume.php"><i class="fa-solid fa-code"> </i>RESUME</a>
              </li>
              <hr>
              <li class="nav-item">
                <a class="nav-link" href="./services.php"><i class="fa-solid fa-bars-staggered"></i>
                  SERVICES</a>
              </li>
              <hr>
              <li class="nav-item">
                <a class="nav-link" href="./portfolio.php"><i class="fa-solid fa-diagram-project"></i>
                  PORTFOLIO</a>
              </li>
              <hr>
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a class="nav-link" href="./admin/index.php"><i class="fa-solid fa-comment"></i> Login</a>
              </li>
              <hr>
            </ul>
