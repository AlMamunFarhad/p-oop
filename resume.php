                    ...
                    <div class="resume">
                        ...
                        <div class="summarise mb-4">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-10">
                                    <p>I'm a highly skilled web designer and developer with 4 years of experience,
                                        seeking a challenging position in a dynamic and innovative company. My expertise
                                        includes HTML, CSS, Sass, Bootstrap, Tailwind CSS, JavaScript, jQuery, PHP, OOP,
                                        Laravel, and WordPress. Committed to continuous learning and passionate about
                                        delivering exceptional results, I'm excited about contributing to new projects
                                        and challenges, creating visually stunning and functional websites.</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-9">
                                    <div class="resume-content">
                                        <div class="work-experinces">
                                            ...
                                            <h4>Web Developer</h4>
                                            <p>I have gained extensive experience working as a web developer across
                                                various online marketplaces as well as in local markets. I am passionate
                                                about my work and eager to contribute my skills to your team. Given the
                                                opportunity, I am committed to delivering my best and making a positive
                                                impact.</p>
                                            <ul>
                                                <li>Utilized PHP for server-side scripting, database management, and
                                                    backend development</li>
                                                <li>Applied Object-Oriented Programming (OOP) concepts to architect
                                                    scalable and maintainable codebases.</li>
                                                <li>Advanced skills in PHP programming and Laravel framework.</li>
                                            </ul>
                                            <h4>Website Maintenance</h4>
                                            <p class="text-end"> FictoTech Solutions Ltd | 2022 - 2023
                                            </p>
                                            <p>At FictoTech Solutions Ltd, I spearheaded website updates, coding, and
                                                collaborated on new features. Additionally, I diligently monitored
                                                analytics and provided crucial technical support. My contributions
                                                significantly enhanced cutting-edge IT solutions and digital
                                                transformation services, benefiting businesses in Bangladesh and beyond.
                                            </p>
                                            <h4>Web Designer</h4>
                                            <p class="text-end"> Design Tech Solutions | 2021 -
                                                2022
                                            </p>
                                            <p>I had the pleasure of working as a web designer at Design Tech Solutions,
                                                where I collaborated on various projects. My experience with the company
